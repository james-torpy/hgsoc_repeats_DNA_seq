# Run command:
# snakemake --reason --use-conda --cores 175 --cluster-config cluster.json --cluster 'qsub -pe smp {cluster.cores} -N cnv_ident.smk -wd '/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/DNA-seq/logs' -b y -j y -V -P TumourProgression' -j 5
...
# max genomes than can be run at one one time (based on 10 TB quota): 6, and 4 in queue
...
#    "AOCS-063-sub"
    ...
    "AOCS-094", "AOCS-095", "AOCS-107", 
    "AOCS-108", 
    "AOCS-109", "AOCS-111", "AOCS-112", "AOCS-113", 
    "AOCS-114", "AOCS-115",
    "AOCS-116", "AOCS-122", 
    "AOCS-123", "AOCS-124", "AOCS-125"
    #, "AOCS-126", 
#    "AOCS-128", "AOCS-130"
#    "AOCS-131", "AOCS-133", 
